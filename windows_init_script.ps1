...
if ($?) { winget install --id OliverSchwendener.ueli -e --source winget --scope user }; # Ueli is a cross-platform keystroke launcher
...
if ($?) { winget install --id PuTTY.PuTTY -e --source winget }
